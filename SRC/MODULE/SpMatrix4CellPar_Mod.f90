MODULE SpMatrix4CellPar_Mod
  ...
  INTERFACE BiCGStabSp
    MODULE PROCEDURE BiCGStab_Vec4CellSp
  END INTERFACE
  INTERFACE SolveSourceSp
    MODULE PROCEDURE SolveSource_Vec4CellSp
  END INTERFACE
  INTERFACE MatVec
    MODULE PROCEDURE MatVec_Vec4CellSp
  END INTERFACE
  INTERFACE PSolve
...
SUBROUTINE MatVec_Vec4CellSp(Ax,A,x)
...
SUBROUTINE SolveSource_Vec4CellSp(Px,P)
  ...
  END DO
END SUBROUTINE SolveSource_Vec4CellSp
...
SUBROUTINE BiCGStab_Vec4CellSp(A,x,b,MaxIter,Tol)
...
END SUBROUTINE BiCGStab_Vec4CellSp
