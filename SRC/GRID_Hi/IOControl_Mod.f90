...
SUBROUTINE Prot_ProgTime
   ...
   CHARACTER(8) D, date
!  CALL DATE_AND_TIME(BIG_BEN(1),BIG_BEN(2),BIG_BEN(3),DATE_TIME)  !OSSI
!  D=date()  !OSSI
...
SUBROUTINE WriteAuswAnalyzeAllCellsToProt
   Write(OutUnitProt,*)
   Write(OutUnitProt,*) trenn2
   Write(OutUnitProt,*) leerzei6,"     >>>>   AnalyzeAllCells     <<<<"
   Write(OutUnitProt,*) trenn2
END SUBROUTINE WriteAuswAnalyzeAllCellsToProt

SUBROUTINE WriteEndAnalyzeAllCellsToProt
   Write(OutUnitProt,*)
   Write(OutUnitProt,*) leerzei6,"    >>>>   Ende:  AnalyzeAllCells   <<<<"
...
SUBROUTINE WriteAuswWeightToProt
   Write(OutUnitProt,*)
   Write(OutUnitProt,*) trenn2
   Write(OutUnitProt,*) leerzei6,"     >>>>   Auswertung  Weight2   <<<<"
   Write(OutUnitProt,*) trenn2
END SUBROUTINE WriteAuswWeightToProt

SUBROUTINE WriteEndWeightToProt
   Write(OutUnitProt,*) leerzei6
   Write(OutUnitProt,*) leerzei6,"    >>>>   Ende Auswertung  Weight2   <<<<"
   Write(OutUnitProt,*) trenn2
   WRITE(OutUnitProt,*)
...
SUBROUTINE WriteAuswSoilLayerToProt
   Write(OutUnitProt,*)
   Write(OutUnitProt,*) trenn2
   Write(OutUnitProt,*) leerzei6,"     >>>>   Auswertung  SoilLayer   <<<<"
   Write(OutUnitProt,*) trenn2
END SUBROUTINE WriteAuswSoilLayerToProt

SUBROUTINE WriteEndSoilLayerToProt
   Write(OutUnitProt,*)
   Write(OutUnitProt,*) leerzei6,"    >>>>   Ende Auswertung  SoilLayer   <<<<"
   Write(OutUnitProt,*) trenn2
   WRITE(OutUnitProt,*)
...
SUBROUTINE WriteAuswCellsOroGMVToProt
   Write(OutUnitProt,*)
   Write(OutUnitProt,*) trenn2
   Write(OutUnitProt,*) leerzei6,"     >>>>   Auswertung  CellsOro...GMV   <<<<"
   Write(OutUnitProt,*) trenn2
END SUBROUTINE WriteAuswCellsOroGMVToProt

SUBROUTINE WriteEndCellsOroGMVToProt
   Write(OutUnitProt,*)
   Write(OutUnitProt,*) leerzei6,"    >>>>   Ende Auswertung  CellsOro...GMV   <<<<"
   Write(OutUnitProt,*) trenn2
   WRITE(OutUnitProt,*)
...
! Write(*,*) ">....... Output Topography        :  ", "----", string_a, "----"
! Write(*,*) ">....... Output Topography        :  ", "----", string_b, "----"
...
SUBROUTINE Display_AnalyzeAllRandCells
  Write(*,*)
  Write(*,*) ">....... Analyze Cells of borders :  ", "........"
END SUBROUTINE Display_AnalyzeAllRandCells
