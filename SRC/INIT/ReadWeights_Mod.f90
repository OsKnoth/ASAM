...
&                 MPI_COMM_WORLD, MPIErr) 
  END DO
  IF (MyId==0) THEN
    IF(PrintNameLists) WRITE(*,*) 'VL'
    DO ib=1,nb
      DO ibn=ib,nb
        IF (ABS(VL(ib,ibn)-VL(ibn,ib))>=1.d-8*MAX(VL(ib,ibn),VL(ibn,ib)).AND.MAX(VL(ib,ibn),VL(ibn,ib))>0.0d0) THEN
          WRITE(*,*) ib,ibn,VL(ib,ibn),VL(ibn,ib)
        END IF  
      END DO  
    END DO  
    IF(PrintNameLists) WRITE(*,*) 'VR'
    DO ib=1,nb
      DO ibn=ib,nb
        IF (ABS(VR(ib,ibn)-VR(ibn,ib))>=1.d-8*MAX(VR(ib,ibn),VR(ibn,ib)).AND.MAX(VR(ib,ibn),VR(ibn,ib))>0.0d0) THEN
          WRITE(*,*) ib,ibn,VR(ib,ibn),VR(ibn,ib)
        END IF  
      END DO  
    END DO  
    IF(PrintNameLists) WRITE(*,*) 'FUL'
    DO ib=1,nb
      DO ibn=ib,nb
        IF (ABS(FUL(ib,ibn)-FUL(ibn,ib))>=1.d-8*MAX(FUL(ib,ibn),FUL(ibn,ib)).AND.MAX(FUL(ib,ibn),FUL(ibn,ib))>0.0d0) THEN
          WRITE(*,*) ib,ibn,FUL(ib,ibn),FUL(ibn,ib)
        END IF  
      END DO  
    END DO  
    IF(PrintNameLists) WRITE(*,*) 'FUR'
    DO ib=1,nb
      DO ibn=ib,nb
        IF (ABS(FUR(ib,ibn)-FUR(ibn,ib))>=1.d-8*MAX(FUR(ib,ibn),FUR(ibn,ib)).AND.MAX(FUR(ib,ibn),FUR(ibn,ib))>0.0d0) THEN
          WRITE(*,*) ib,ibn,FUR(ib,ibn),FUR(ibn,ib)
        END IF  
      END DO  
    END DO  
    IF(PrintNameLists) WRITE(*,*) 'FVL'
    DO ib=1,nb
      DO ibn=ib,nb
        IF (ABS(FVL(ib,ibn)-FVL(ibn,ib))>=1.d-8*MAX(FVL(ib,ibn),FVL(ibn,ib)).AND.MAX(FVL(ib,ibn),FVL(ibn,ib))>0.0d0) THEN
          WRITE(*,*) ib,ibn,FVL(ib,ibn),FVL(ibn,ib)
        END IF  
      END DO  
    END DO  
    IF(PrintNameLists) WRITE(*,*) 'FVR'
    DO ib=1,nb
      DO ibn=ib,nb
        IF (ABS(FVR(ib,ibn)-FVR(ibn,ib))>=1.d-8*MAX(FVR(ib,ibn),FVR(ibn,ib)).AND.MAX(FVR(ib,ibn),FVR(ibn,ib))>0.0d0) THEN
          WRITE(*,*) ib,ibn,FVR(ib,ibn),FVR(ibn,ib)
        END IF  
      END DO  
    END DO  
    IF(PrintNameLists) WRITE(*,*) 'FWL'
    DO ib=1,nb
      DO ibn=ib,nb
        IF (ABS(FWL(ib,ibn)-FWL(ibn,ib))>=1.d-8*MAX(FWL(ib,ibn),FWL(ibn,ib)).AND.MAX(FWL(ib,ibn),FWL(ibn,ib))>0.0d0) THEN
          WRITE(*,*) ib,ibn,FWL(ib,ibn),FWL(ibn,ib)
        END IF  
      END DO  
    END DO  
    IF(PrintNameLists) WRITE(*,*) 'FWR'
    DO ib=1,nb
      DO ibn=ib,nb
        IF (ABS(FWR(ib,ibn)-FWR(ibn,ib))>=1.d-8*MAX(FWR(ib,ibn),FWR(ibn,ib)).AND.MAX(FWR(ib,ibn),FWR(ibn,ib))>0.0d0) THEN
...
&                 MPI_COMM_WORLD, MPIErr) 
  ...
  IF (MyId==0) THEN
    ...
    DO ib=1,nb
      DO ibn=ib,nb
        IF (ABS(VL(ib,ibn)-VL(ibn,ib))>=1.d-8*MAX(VL(ib,ibn),VL(ibn,ib))) THEN
          WRITE(*,*) ib,ibn,VL(ib,ibn),VL(ibn,ib)
        END IF  
      END DO  
    END DO  
    ...
    DO ib=1,nb
      DO ibn=ib,nb
        IF (ABS(VR(ib,ibn)-VR(ibn,ib))>=1.d-8*MAX(VR(ib,ibn),VR(ibn,ib))) THEN
          WRITE(*,*) ib,ibn,VR(ib,ibn),VR(ibn,ib)
        END IF  
      END DO  
    END DO  
    ...
    DO ib=1,nb
      DO ibn=ib,nb
        IF (ABS(FUL(ib,ibn)-FUL(ibn,ib))>=1.d-8*MAX(FUL(ib,ibn),FUL(ibn,ib))) THEN
          WRITE(*,*) ib,ibn,FUL(ib,ibn),FUL(ibn,ib)
        END IF  
      END DO  
    END DO  
    ...
    DO ib=1,nb
      DO ibn=ib,nb
        IF (ABS(FUR(ib,ibn)-FUR(ibn,ib))>=1.d-8*MAX(FUR(ib,ibn),FUR(ibn,ib))) THEN
          WRITE(*,*) ib,ibn,FUR(ib,ibn),FUR(ibn,ib)
        END IF  
      END DO  
    END DO  
    ...
    DO ib=1,nb
      DO ibn=ib,nb
        IF (ABS(FVL(ib,ibn)-FVL(ibn,ib))>=1.d-8*MAX(FVL(ib,ibn),FVL(ibn,ib))) THEN
          WRITE(*,*) ib,ibn,FVL(ib,ibn),FVL(ibn,ib)
        END IF  
      END DO  
    END DO  
    ...
    DO ib=1,nb
      DO ibn=ib,nb
        IF (ABS(FVR(ib,ibn)-FVR(ibn,ib))>=1.d-8*MAX(FVR(ib,ibn),FVR(ibn,ib))) THEN
          WRITE(*,*) ib,ibn,FVR(ib,ibn),FVR(ibn,ib)
        END IF  
      END DO  
    END DO  
    ...
    DO ib=1,nb
      DO ibn=ib,nb
        IF (ABS(FWL(ib,ibn)-FWL(ibn,ib))>=1.d-8*MAX(FWL(ib,ibn),FWL(ibn,ib))) THEN
          WRITE(*,*) ib,ibn,FWL(ib,ibn),FWL(ibn,ib)
        END IF  
      END DO  
    END DO  
    ...
    DO ib=1,nb
      DO ibn=ib,nb
        IF (ABS(FWR(ib,ibn)-FWR(ibn,ib))>=1.d-8*MAX(FWR(ib,ibn),FWR(ibn,ib))) THEN
          WRITE(*,*) ib,ibn,FWR(ib,ibn),FWR(ibn,ib)
        END IF  
      END DO  
    END DO  
    ...
    S:DO
      ...
      IF (INDEX(Line,'#.... Block')>0) THEN
        ...
        IF(ib==ibInput) THEN 
          ...
          IF (nxWeight/=Floor(ib)%ix1-Floor(ib)%ix0) THEN
            WRITE(*,*) MyId,'Error WeightFile (nx)',ib,Floor(ib)%ix0,Floor(ib)%ix1,nxWeight
            STOP 'Error WeightFile (nx)'
          END IF  
...
!         FU=0.0d0 !OSSI
          ...
          DO i=1,Floor(ib)%NumBoundCell
            ...
            iy=Floor(ib)%BoundCell(i)%iy
            iz=Floor(ib)%BoundCell(i)%iz
            Floor(ib)%zH(ix,iy)=MIN(Floor(ib)%zH(ix,iy),Floor(ib)%BoundCell(i)%zS)
            Floor(ib)%BoundCell3d(ix,iy,iz)=i
            !..............................
            ...
            IF (FL>0.d0) THEN
              ...
              n2=n2/FL
              n3=n3/FL
              Floor(ib)%BoundCell(i)%n1=n1 ! x component of the normal vector
              Floor(ib)%BoundCell(i)%n2=n2 ! y component of the normal vector
              Floor(ib)%BoundCell(i)%n3=n3 ! z component of the normal vector
              Floor(ib)%BoundCell(i)%FL=FL ! surface area of the cut cross section in a boundary cell
              Floor(ib)%BoundCell(i)%dL=Half*SQRT((n1*dx(ix))**2+(n2*dy(iy))**2+(n3*dz(iz))**2)
            ELSE
              ...
              n2=0.d0
              n3=1.d0 
              Floor(ib)%BoundCell(i)%n1=n1
              Floor(ib)%BoundCell(i)%n2=n2
              Floor(ib)%BoundCell(i)%n3=n3
  ...
  DO ib=1,nb
    ...
    IF (blMPI(ib)%Proc==MyId) THEN
      ...
      END DO
      IF (FillValue) THEN
        Floor(ib)%FreeCells=(ix1Out-ix0Out)*(iy1Out-iy0Out)*(iz1Out-iz0Out)
      END IF  
    END IF
...
!       VolFace(ibLoc)%w_t(ix,iy)=Half*SUM(VolC(ix,iy,iz0+1:iz1))
  ...
  IF(PrintNameLists) WRITE(*,*) 'TestWeight'
  CALL TestWeight
! CALL TestWeight2
