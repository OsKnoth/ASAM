...
END MODULE WaveExperiment_Mod

SUBROUTINE SetBoundCells(BoundCellLoc)

  USE WaveExperiment_Mod
  USE DataType_Mod
  IMPLICIT NONE
  TYPE(BoundCell_T) :: BoundCellLoc

  IF (SQRT(BoundCellLoc%xS**2+BoundCellLoc%yS**2)>rMean) THEN
