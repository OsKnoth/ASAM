MODULE Canopy_rans_Mod
  ...
  REAL(RealKind) :: zRauh_c=0.05 ! roughness length for canopy soil
...
SUBROUTINE SetBoundCells(BoundCellLoc)
  ...
  ! BoundCellLoc%TeS = 100.0d0
  ! BoundCellLoc%ee= 1.6d0
...
FUNCTION ThStart(x,y,z,zHeight,Time)
  ...
  ELSE
    ...
    END IF
    ThStart = ThStart + ran_spread(-0.1d0,0.1d0)
  END IF
...
FUNCTION ThStartSoil(x,y,z,zHeight,zSoil,LandClass,SoilType,Time)
  ...
  END IF
  ! write(*,*) 'Example: ThStartSoil.', zSoil, ThStartSoil
...
FUNCTION QvStartSoil(x,y,z,zHeight,zSoil,LandClass,SoilType,Time)
  ...
  ELSE
    ...
    END IF
  END IF
  ! write(*,*) 'Example: QvStartSoil.', zSoil, QvStartSoil
