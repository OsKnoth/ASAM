SUBROUTINE kritxd(r_qsa,r_sol,r_dry,m_sol,S_krit,r_krit,m_krit,a_sig,TABS,J,I,i_lm,j_lm,k_lm)
  ...
  IF (icond == 1) THEN 
     ...
     DO ITER=1,ITERMAX
        ...
        s_ggw1=exp(2.D0*(a_sig+ bb*molality1)/(RHOW*RW*TABS*r_wet1)  &
             - molality1*vantS*mol_w*Phi_S1)-1.D0
        ...
        s_ggw2=exp(2.D0*(a_sig+ bb*molality2)/(RHOW*RW*TABS*r_wet2)  &
             - molality2*vantS*mol_w*Phi_S2)-1.D0
